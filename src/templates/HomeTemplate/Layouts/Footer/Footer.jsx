...
function Footer() {
    ...
    const renderDoiTac = () => {
        return arrTheaterSystem.map((item, index) => {
            return (
                <li key={index}>
                    <NavLink to="/" className="hover:dark:text-violet-400">
            ...
            <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-6 text-center md:text-left md:col-span-4">
                        ...
                        <ul className="grid grid-cols-3 gap-y-3 m-0">{renderDoiTac()}</ul>
                    </div>
                    <div className="space-y-3 md:col-span-4">
                        <p className="pb-1 text-lg font-medium">Social media</p>
